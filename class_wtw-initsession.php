...
class wtw {
	...
	public function loadMetaData() {
		...
		try {
			...
			$zsitedescription = 'roomz: Internationally Patented 3D Internet Browsing and 3D Website hosting. roomz (R), http://3d (TM), https://3d (TM), and Bixma (TM).';
			...
			if ($this->pagename == 'admin.php') {
				...
				$zsitedescription = "roomz Admin: Patented 3D Internet Browsing and 3D Website hosting. roomz (R), http://3d (TM), https://3d (TM), and Bixma (TM).";
			}
			...
			$zmetadata .= "<meta name='keywords' content=\"roomz,3D Internet,Metaverse,Multiverse,open-source,Bixma,".$zsitedescription."\" />\r\n";
